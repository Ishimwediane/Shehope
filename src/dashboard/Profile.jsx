...
const Profile = ({ userId }) => {
  ...
  const handleCancel = () => {
    ...
    // Optionally, you can refetch the data or reset state to initial user data
  };

  const profilePic = userData.profile_picture || <FaUserCircle className="w-20 h-20 text-gray-400" />;

  return (
    <div className="ml-70 mt-15 max-w-4xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      {/* Profile Header */}
      <div className="flex items-center justify-between border-b pb-4">
        ...
        <button onClick={() => setIsEditing(!isEditing)} className="flex items-center gap-1 text-blue-500 hover:underline">
      ...
      <div className="mt-6 border-b pb-4">
        ...
        <div className="grid grid-cols-2 gap-4 mt-2 text-gray-700">
          ...
          <p><strong>Pregnancy Status:</strong> {isEditing ? (
            <input
              type="text"
          ...
          <p><strong>Trimester:</strong> {isEditing ? (
            <select
              name="trimester"
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-2 gap-4 mt-2 text-gray-700">
          ...
          <p><strong>City:</strong> Kigali</p>
          <p><strong>Preferred Language:</strong> English</p>
          <p><strong>Support Needed:</strong> Mental Health, Legal Advice</p>
        </div>
      </div>

      {isEditing && (
        <div className="mt-4 flex justify-end gap-4">
          <button onClick={handleCancel} className="bg-gray-300 text-white px-4 py-2 rounded-lg">Cancel</button>
